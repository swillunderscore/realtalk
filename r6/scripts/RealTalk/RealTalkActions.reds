...
public class StActions extends IScriptable {
    ...
    public func RestoreFollowers(game: GameInstance) -> Bool {
        ...
        let dto = FromJson(root, n"RealTalk.StFollowFileDTO") as StFollowFileDTO;
    ...
    // used by the diagnostics (RealTalkDiag.reds).
    ...
    private func Attack(npc: ref<NPCPuppet>) -> Void {
        ...
        // straight out of the AI's own state - see RealTalkDiag.reds. This
