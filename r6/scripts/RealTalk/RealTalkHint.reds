...
//  in RealTalkUI.ShowHint/HideHint.
//
...
public class RealTalkHintSystem extends ScriptableSystem {
    private let shown: Bool;
    private let ticks: Int32;

    // ---- overheard dialogue (see RealTalkOverheard.reds) ----
    ...
    // Called from the subtitle line controllers (RealTalkOverheard.reds).
...
public class StHintTick extends DelayCallback {
    public let system: wref<RealTalkHintSystem>;
