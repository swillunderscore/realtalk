...
//
//    Two earlier attempts are recorded in RealTalkProbe.reds so they are not
...
public class RealTalkUI extends ScriptableSystem {
    ...
    public func Show(speakerName: String) -> Void {
        ...
        panel.SetName(n"realtalk_panel");
        ...
        lines.SetName(n"realtalk_lines");
        ...
        // the raw-key layer (see RealTalkInput.reds), which is how the mods
        ...
        foot.SetName(n"realtalk_footer");
    ...
    public static func Get() -> ref<RealTalkUI> {
        return GameInstance.GetScriptableSystemsContainer(GetGameInstance())
            .Get(n"RealTalk.RealTalkUI") as RealTalkUI;
    }
}
