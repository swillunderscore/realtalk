...
//    RealTalkConfig.reds for anyone running something unusual.
//
...
enum StProvider {
    ...
    Custom = 5,        // whatever is in RealTalkConfig.reds
}
...
public class RealTalkSettings extends ScriptableSystem {
    ...
    @runtimeProperty("ModSettings.description", "Write a diagnostic log to r6/storages/RealTalk/realtalk.log - including each NPC's full character card. Off by default; nothing is written at all while off, and conversation text is never logged.")
    ...
    public static func Get() -> ref<RealTalkSettings> {
        return GameInstance.GetScriptableSystemsContainer(GetGameInstance())
            .Get(n"RealTalk.RealTalkSettings") as RealTalkSettings;
    }

    public func OpenKeyCode() -> String {
        return RealTalkSettings.KeyCode(this.openKey);
    }

    public func ResetKeyCode() -> String {
        return RealTalkSettings.KeyCode(this.resetKey);
    }

    public func OpenKeyLabel() -> String {
        return RealTalkSettings.KeyLabel(this.openKey);
    }

    public func ResetKeyLabel() -> String {
        return RealTalkSettings.KeyLabel(this.resetKey);
    }

    public func UndoKeyCode() -> String {
        return RealTalkSettings.KeyCode(this.undoKey);
    }

    public func UndoKeyLabel() -> String {
        return RealTalkSettings.KeyLabel(this.undoKey);
    }
    ...
    public func GetEndpoint() -> String {
        switch this.provider {
            ...
            case StProvider.Custom:
                return RealTalkConfig.Get().customBaseUrl;
