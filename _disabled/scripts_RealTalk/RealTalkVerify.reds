...
public class RealTalkVerifySystem extends ScriptableSystem {
    ...
    public func Verify() -> Void {
        let ourAction: TweakDBID = t"ObjectAction.RealTalk_Talk";
...
public class StVerifyOnce extends DelayCallback {
    public let system: wref<RealTalkVerifySystem>;
